...
summary: "UPDATED 2026-04-05: Five closed exception sets confirmed — {1,2,3}=27, {1,2,4}=64, {1,2,5}=374, {1,2,6}=1834, and NEW {1,2,7}=7178 (verified to 10^11). A sharp density threshold is observed for sets of the form {1,2,k}, but computational data (e.g., density_A2345_1e9 = 0.972937480 for A = {2,3,4,5}) shows that full density does not coincide with Hausdorff dimension δ = 1/2: {2,3,4,5} has δ > 1/2 yet fails to reach full density (only 97.3% at 10^9). The threshold mechanism involves the presence of digit 1, not solely Hausdorff dimension. The presence of digit 1 appears necessary for full density, consistent with the semigroup transitivity criterion: for any finite set A containing 1, the associated semigroup acts transitively on (ℤ/pℤ)^2 for every prime p (see Bourgain–Fuchs (2011), Lemma 2 and Theorem 1.1). A={1,2,3} gives 99.9999997% density at 10^10. 8xB200 overnight batch produced 17 new results at 10^11 scale."
