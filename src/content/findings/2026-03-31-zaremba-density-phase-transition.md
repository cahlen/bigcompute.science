...
summary: "UPDATED 2026-04-05: Five closed exception sets confirmed — {1,2,3}=27, {1,2,4}=64, {1,2,5}=374, {1,2,6}=1834, and NEW {1,2,7}=7178 (verified to 10^11). Computational data show there is NOT a sharp phase transition at Hausdorff dimension δ = 1/2: For instance, density_A2345_1e9 = 0.972937480 for A = {2,3,4,5}, even though its Hausdorff dimension δ ≈ 0.71145 > 1/2 (Hensley 1992). This violates the simple δ > 1/2 threshold. Instead, the mechanism for full density involves the presence of digit 1 (see explicit numerical evidence above), consistent with the semigroup transitivity criterion; see also BK14, which proves positive lower density for δ > 1/2 but not full density. Thus, Hensley's phase transition conjecture is not supported by current computational data for full density. It is a theorem (Bourgain–Fuchs 2011, Lemma 2): If 1 ∈ A, then the semigroup Γ_A generated by matrices [ 0 1; 1 a ], a ∈ A, acts transitively on (ℤ/pℤ)^2 for every prime p. See Bourgain, J., & Fuchs, E. (2011). A proof of Zaremba’s conjecture for a density one subset of integers. Annals of Mathematics, 173(2), 991–1016, Lemma 2 and Theorem 1.1. A={1,2,3} gives 99.9999997% density at 10^10. 8xB200 overnight batch produced 17 new results at 10^11 scale."
