...
Witness tables and analysis scripts are in the [idontknow repository](https://github.com/cahlen/idontknow/tree/main/scripts/experiments/zaremba-effective-bound). Raw witness CSVs are generated by the experiment pipeline and published alongside verification logs where available.
